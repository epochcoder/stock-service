...
public interface StockService {
     ...
     */
    StockItem update(Long id, StockItem item) throws StockNotFoundException;
     ...
     *
     * @param pageable the pageable range to retrieveAll
     * @return the retrieved stock items
     */
    Page<StockItem> retrieveAll(Pageable pageable);
